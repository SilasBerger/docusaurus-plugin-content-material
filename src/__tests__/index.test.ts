...
import pluginContentMaterial from '../index';
...
describe('sidebar', () => {
  it('site with wrong sidebar content', async () => {
    ...
    const plugin = await pluginContentMaterial(
      context,
      validateOptions({
...
describe('simple website', () => {
  async function loadSite() {
    ...
    const plugin = await pluginContentMaterial(context, options);
